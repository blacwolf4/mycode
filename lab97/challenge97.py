...
def zodiac(tiger):
    for year in tiger.keys():
        print(f"{usr_name} your zodiac sign is {sign}, you are {sign_attr}.")
    for year in rabbit.keys():
        print(f"{user_name} your zoidac sign is {sign}, you are {sign_attr}.")
